...
<head>
    ...
    <title>{{ config('app.title') }} | Error 404</title>
    <meta
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-lg-8 col-xxl-6 text-center">
                        <div class="text-warning fw-bolder" style="font-size: 150px;">404</div>
                        <h1><i class="fas fa-search text-warning me-2"></i> Oops! Page not found.</h1>
                        <p>The page you're trying to access doesn't exists or has been removed.</p>
