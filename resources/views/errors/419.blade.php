...
<head>
    ...
    <title>{{ config('app.title') }} | Error 419</title>
    <meta
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-lg-8 col-xxl-6 text-center">
                        <div class="text-warning fw-bolder" style="font-size: 150px;">419</div>
                        <h1><i class="fas fa-hourglass-end text-warning me-2"></i> Oops! Page expired.</h1>
                        <p>Your session has been ended. Please back to home and try again.</p>
