...
<head>
    ...
    <title>{{ config('app.title') }} | Error 500</title>
    <meta
            ...
            <div class="d-flex align-items-center justify-content-center w-100">
                <div class="row justify-content-center w-100">
                    <div class="col-lg-8 col-xxl-6 text-center">
                        <div class="text-warning fw-bolder" style="font-size: 150px;">500</div>
                        <h1><i class="fas fa-times-circle text-warning me-2"></i> Oops! Server error.</h1>
