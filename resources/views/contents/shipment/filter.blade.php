        ...
        <div class="accordion-body">
            <div class="card-body">
                <form id="filter-form" class="row px-3 pb-3">
                    ...
                    <div class="form-group col-md-3">
                        <select name="category" class="form-select select2" id="category">
                            ...
                            @foreach ($categories as $category)
                                <option value="{{ encrypt($category->id) }}">{{ strtoupper($category->name) }}</option>
                            @endforeach
                        </select>
                    </div>
                    <div class="form-group col-md-3">
                    ...
                    <div class="form-group col-md-3">
                        <input type="text" name="date" id="date" class="form-control text-uppercase" placeholder="ALL DATES">
                    </div>
