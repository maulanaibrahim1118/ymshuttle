        ...
        success: function (res) {
            if (res.data.length > 0) {
                ...
                if (res.next_page_url) {
                    ...
                    finished = true;
                    $("#scrollSentinel").html(
                        '<p class="text-muted mt-3">All shipment collection have been shown.</p>'
                    );
                }
            } else {
                if (!append) {
                    $("#shipmentCards").html("");
                    $("#scrollSentinel").html(
                        '<p class="text-muted mt-3">Shipment collection not found.</p>'
                    );
                } else {
                    finished = true;
                    $("#scrollSentinel").html(
                        '<p class="text-muted mt-3">No shipment collection available.</p>'
                    );
                }
            }
            ...
            $("#reloadShipment").show();
            $("#totalData").text(
                `Total shipment collection(s): ${res.total ?? 0} ${
